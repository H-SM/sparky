...
def main():
    ...
    try:
        ...
        edge_file_path = "twitter_combined.txt"  # Replace with your actual file path
        ...
        vertices, edges = load_edge_dataset(spark, edge_file_path, use_hdfs=False)  # Set to True if HDFS is configured
